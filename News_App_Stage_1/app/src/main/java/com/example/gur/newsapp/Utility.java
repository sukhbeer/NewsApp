...
public final class Utility {
    ...
    public static List<News> fetchNewsItems(String requestUrl) throws JSONException {
    ...
    private static List<News> parseJSON(String response) throws JSONException {
        ...
        for (int i = 0; i < resultsArray.length(); i++) {
            ...
            newsItems.add(new News(title, pubDate, section, url, author));
        }
        return newsItems;
    }
